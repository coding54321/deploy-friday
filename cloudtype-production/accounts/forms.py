...
class CafeCreationForm(forms.ModelForm):
    ...
    cafe_photo = forms.ImageField(required=False)

    class Meta:
        model = Cafe
        fields = ('cafe_id', 'cafe_name', 'telephone', 'cafe_photo')
...
class CafeChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = Cafe
        fields = ('cafe_id', 'cafe_name', 'telephone', 'password', 'is_superuser', 'cafe_photo')
